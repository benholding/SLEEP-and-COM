...
packages <- c("brms", "plyr", "dplyr", "data.table", "lubridate", "tidyr", "apaStyle","sjstats", "BEST", "ggridges") #packages that are required
...
hdi.Score_describer <- score.hdi[10,]
hdi.Score_builder <- score.hdi[11,]
```
...
hdi.Time_describer <- time.hdi[2,]
hdi.Time_builder <- time.hdi[3,]
...
hdi.Efficiency_describer <- efficiency.hdi[2,]
hdi.Efficiency_builder <- efficiency.hdi[3,]
```
...
simple_Lego_Score <- data.frame(row.names = "Score",
                         Intercept = h0.Beskrivare$hypothesis$Estimate,
