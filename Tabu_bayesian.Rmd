...
## Bayes Factor
tabu.h0.Speaker <- hypothesis(tabu.cumulative.model, "Speaker_SD = 0"); plot(tabu.h0.Speaker)
tabu.h0.guesser <- hypothesis(tabu.cumulative.model, "Guesser_SD = 0"); plot(tabu.h0.guesser)
